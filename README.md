...
A production-g rade full-stack web platform that converts Android agriculture app logic into a modern web application. Built with React + Vite, Flask, MongoDB and Docker.
